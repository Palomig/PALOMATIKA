...
<div x-data="registerForm()">
    <h1 class="text-2xl font-bold text-gray-900 text-center mb-2">Создать аккаунт</h1>
    <p class="text-gray-500 text-center mb-6">3 дня бесплатного доступа</p>

    <!-- Error message -->
    <div x-show="error" x-cloak class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg mb-4">
        <span x-text="error"></span>
    </div>

    <!-- Validation errors -->
    <div x-show="Object.keys(errors).length > 0" x-cloak class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-lg mb-4">
        ...
        <div class="space-y-4">
            ...
            <div>
                <label class="flex items-start">
                    <input type="checkbox" x-model="agree" class="w-4 h-4 mt-1 text-purple-600 border-gray-300 rounded focus:ring-purple-500" required>
                    <span class="ml-2 text-sm text-gray-600">
                        Я согласен с <a href="#" class="text-purple-600 hover:underline">условиями использования</a>
                        и <a href="#" class="text-purple-600 hover:underline">политикой конфиденциальности</a>
                    </span>
                </label>
            </div>
    ...
    <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white text-gray-500">или через соцсети</span>
        </div>
    </div>
    ...
    <p class="text-center text-gray-600 mt-6">
        Уже есть аккаунт?
        <a href="{{ route('login') }}" class="text-purple-600 font-medium hover:text-purple-800">Войти</a>
    </p>
</div>
