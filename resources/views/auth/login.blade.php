...
<div x-data="loginForm()">
    <h1 class="text-2xl font-bold text-gray-900 text-center mb-2">Вход в аккаунт</h1>
    <p class="text-gray-500 text-center mb-6">Продолжите подготовку к ОГЭ</p>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center">
                    <input type="checkbox" x-model="remember" class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
    ...
    <p class="text-center text-gray-600 mt-6">
        Нет аккаунта?
        <a href="{{ route('register') }}" class="text-purple-600 font-medium hover:text-purple-800">Зарегистрироваться</a>
    </p>
</div>
