...
--}}
{{-- Обёртка в <style> обязательна: `head-config` выводит стек `styles`
    ...
    <style>
        ...
        /* KaTeX рисует знак корня инлайновым SVG, и высоту ему задаёт обёртка
           (`height: inherit`). Без этой строки правило выше съедает радикал. */
        .fipi-condition .katex svg, .fipi-options .katex svg { height: inherit; max-width: none; }
