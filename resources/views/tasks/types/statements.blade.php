{{--
    ...
    Для варианта ОГЭ: отображает 3 утверждения с нумерацией 1), 2), 3)
--}}
...
@if($isOgeVariant)
    ...
    <div class="space-y-4">
        @foreach($statements as $statement)
            ...
            <div class="bg-slate-800/70 rounded-xl p-5 border-l-4 border-slate-600">
                <div class="flex items-start gap-4">
                    <span class="text-purple-400 font-bold text-lg shrink-0">{{ $displayNumber }})</span>
...
@else
    {{-- Полный режим для страницы темы --}}
