...
<div class="page" x-data="resultsPage()" x-cloak>
  ...
  <div class="topbar anim-down">
    <a href="{{ route('pwa.student.vpr.home') }}" class="back-btn">&lsaquo;</a>
    <div>
  ...
  <div class="tutor-cta anim-up" style="animation-delay:0.3s">
    ...
    <div class="tutor-cta-body">
      ...
      <a href="{{ url('/tutor') }}" class="btn-cta">Записаться к репетитору</a>
  ...
  {{-- RETRY --}}
  <a href="{{ route('pwa.student.vpr.home') }}" class="btn-retry anim-up" style="animation-delay:0.4s">
