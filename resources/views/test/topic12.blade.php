...
<div class="max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8 text-sm bg-slate-800/50 rounded-xl p-4 border border-slate-700">
        ...
        <div class="flex gap-2 flex-wrap justify-center">
            ...
            <span class="px-2 py-1 rounded bg-emerald-500 text-white font-bold">12</span>
    ...
    <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-white mb-2">12. Расчёты по формулам</h1>
        <p class="text-slate-400 text-lg">Вычисления по физическим и математическим формулам</p>
    </div>
    ...
    <div class="mb-12">
        ...
        <div class="text-center mb-8">
            <h2 class="text-2xl font-bold text-white">12. Расчёты по формулам</h2>
                    ...
                    @foreach($zadanie['tasks'] ?? [] as $taskIndex => $task)
                        <div class="bg-slate-800/70 rounded-xl p-5 border border-slate-700 hover:border-slate-600 transition-colors">
                            <div class="flex gap-4">
                                <span class="text-emerald-400 font-bold text-lg flex-shrink-0">{{ $task['id'] }}.</span>
    ...
    <div class="bg-slate-800 rounded-xl p-6 border border-slate-700 mt-10">
        ...
        <div class="text-slate-400 text-sm space-y-2">
            <p><strong class="text-slate-300">Тема:</strong> 12. Расчёты по формулам</p>
            <p><strong class="text-slate-300">Источник:</strong> {{ $source ?? 'Manual' }}</p>
            <p><strong class="text-slate-300">Контроллер:</strong> <code class="bg-slate-700 px-2 py-1 rounded text-xs">TestPdfController::getAllBlocksData12()</code></p>
...
@include('components.task-review-tool', ['topicId' => '12'])
