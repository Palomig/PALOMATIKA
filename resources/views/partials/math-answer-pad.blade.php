...
@once
  ...
  (function () {
    ...
    var KEYS = {
      ...
      full:    ['√', '(', ')', '[', ']', ';', '/', '±', '∞', '∪'],
      compare: ['≠', '>', '<', '≥', '≤'],
      // Часть 2 профиля ЕГЭ: к набору `full` добавлена π. В задании 13
      // ответ — корни уравнения на отрезке («π/6;π/2»), и без неё ученик
      // не наберёт ответ вообще: на клавиатуре телефона её нет.
      ege2:    ['π', '√', '(', ')', '[', ']', ';', '/', '∪', '∞', '±'],
    };
