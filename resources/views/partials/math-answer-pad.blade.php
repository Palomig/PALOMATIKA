{{--
  ...
  клавиатуре телефона (√, ±, ∞, ∪), и предпросмотр набранного через KaTeX.

  Нужна там, где ответ содержит подкоренное выражение: вторая часть ОГЭ
  (№20 и №23) и вступительная работа в 10 класс. В первой части ОГЭ ответ —
  число или последовательность цифр, панель туда не подключается.
