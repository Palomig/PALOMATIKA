...
<a href="/teacher/oge/teachers" class="flex items-center px-3 py-2.5 rounded-xl transition {{ request()->is('teacher/oge*') ? 'bg-coral/10 text-coral' : 'text-gray-400 hover:bg-dark-lighter hover:text-white' }}">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
