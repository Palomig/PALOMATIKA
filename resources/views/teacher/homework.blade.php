                        ...
                        <div x-show="hw.showDetails" x-collapse class="mt-3">
                            <div class="space-y-1.5">
                                <template x-for="result in hw.results" :key="result.student_id">
                                    <div class="flex items-center justify-between gap-2 px-3 py-2.5 bg-dark/50 rounded-xl">
                                        <div class="flex items-center gap-2.5 min-w-0">
                                            ...
                                            <span class="text-sm text-white truncate" x-text="result.student_name"></span>
                                        </div>
                                        <div class="flex items-center gap-2 flex-shrink-0">
                                            <span class="text-sm font-medium tabular-nums"
                                                  :class="result.completed ? 'text-emerald-400' : 'text-gray-600'"
                                                  x-text="result.completed ? result.score + '%' : 'Нет'"></span>
                                            <span class="text-[11px] text-gray-600 hidden sm:inline" x-text="result.completed_at || ''"></span>
                                        </div>
                                    </div>
                                </template>
                            </div>
