...
class AttachLegacySolutions extends Command
{
    ...
    private const MANUAL = [
        '20' => [
            9  => [10],             // подсказка о записи ответа интервалом
            10 => [11],             // объединение интервалов
            11 => [10],
        ],
        '21' => [
        ...
        '24' => [
            2 => [2, 3, 4],         // биссектрисы и равнобедренные треугольники
            5 => [7, 8],            // середина боковой стороны и средняя линия трапеции
