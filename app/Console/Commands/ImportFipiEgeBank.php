 ...
 *
 * Тема здесь — НОМЕР ЗАДАНИЯ ЕГЭ (01…20), а не раздел математики: именно так
 ...
 * ни номерами заданий (профиль 1–20, база 1–21), ни каталогом рисунков.
...
class ImportFipiEgeBank extends Command
{
    ...
    /** Номера заданий: у профиля их 20 (план КИМ 2027), у базы 21. */
    private const NUMBERS = ['prof' => 20, 'base' => 21];
