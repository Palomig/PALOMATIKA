...
SVG;
    ...
    private function renderTrapezoidCircumscribedAroundCircle(): string
    {
        ...
        //
        // Для левой стороны AB от A(ax, 148) до B(bx, 52):
        // Расстояние от O = |10560 - 48*(ax + bx)| / sqrt(9216 + (bx-ax)²) = 48
        // При ax = 42: bx = 76 (точное касание)
        //
        // Для правой стороны CD от C(cx, 52) до D(dx, 148):
        // При dx = 185: cx = 141 (точное касание)
