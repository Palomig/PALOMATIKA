...
class LessonTaskPickerService
{
    ...
    /**
     * Разделы профиля ЕГЭ по плану КИМ 2027: номера 1–13 дают краткий ответ,
     * 14–20 — развёрнутый. Формат ответа у них разный (число против корней
     * на отрезке или множества промежутков), и учителю удобнее выбирать
     * часть, а не листать двадцать номеров подряд — так же, как в ОГЭ.
     *
     * Граница частей сместилась: экономическая задача (была 16) стала
     * тринадцатой с кратким ответом и ушла в первую часть.
     */
    public const EGE_SECTIONS = [
        'part1' => ['title' => '1я часть', 'topics' => ['01', '02', '03', '04', '05', '06', '07',
                                                        '08', '09', '10', '11', '12', '13']],
        'part2' => ['title' => '2я часть', 'topics' => ['14', '15', '16', '17', '18', '19', '20']],
    ];
