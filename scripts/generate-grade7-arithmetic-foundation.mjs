...
const decimalMulDiv = [
  ["17,1 * 3,8 / 4,5 * 0,5", 17.1 * 3.8 / 4.5 * 0.5],
  ["81,9 / 4,5 / 0,28 * 1,2", 81.9 / 4.5 / 0.28 * 1.2],
  ["2,4 * 1,5 / 0,6", 2.4 * 1.5 / 0.6],
  ["7,2 / 0,9 * 1,25", 7.2 / 0.9 * 1.25],
  ["0,48 / 0,12 * 2,5", 0.48 / 0.12 * 2.5],
  ["3,6 * 2,5 / 0,9", 3.6 * 2.5 / 0.9],
  ["12,5 * 0,8 / 2", 12.5 * 0.8 / 2],
  ["6,3 / 0,7 * 1,4", 6.3 / 0.7 * 1.4],
  ["0,96 / 0,24 * 3,5", 0.96 / 0.24 * 3.5],
  ["15,75 / 2,5 * 0,4", 15.75 / 2.5 * 0.4],
  ["4,8 * 0,75 / 1,2", 4.8 * 0.75 / 1.2],
  ["9,45 / 0,35 * 0,2", 9.45 / 0.35 * 0.2],
  ["1,44 / 0,18 * 2,1", 1.44 / 0.18 * 2.1],
  ["18,6 * 0,5 / 3,1", 18.6 * 0.5 / 3.1],
  ["2,25 * 4,8 / 0,6", 2.25 * 4.8 / 0.6],
  ["11,2 / 1,4 * 0,75", 11.2 / 1.4 * 0.75],
];
...
function makeErrorTasks() {
  const cases = [
    ...
    ["Ученик написал: 18 / 3 * 2 = 3. Объясните ошибку.", "18 / 3 * 2 = 12. Деление и умножение идут слева направо.", "3"],
    ["Ученик написал: 6 - 2 * 4 = 16. Объясните ошибку.", "6 - 2 * 4 = -2. Сначала выполняем умножение.", "16"],
...
const blocks = [
  ...
  block(5, "Порядок действий", [
    ...
    zadanie(2, "Сравните выражения с разными скобками:", "operation_order", makeOperationTasks([
      ["6 - 2 * 4", -2], ["(6 - 2) * 4", 16], ["40 / 5 / 2", 4], ["40 / (5 / 2)", 16],
      ["18 / 3 * 2", 12], ["18 / (3 * 2)", 3], ["20 - 4 * 3", 8], ["(20 - 4) * 3", 48],
      ["2 * (7 - 10)", -6], ["2 * 7 - 10", 4], ["5 + 3 * (2 - 8)", -13], ["(5 + 3) * (2 - 8)", -48],
    ])),
  ]),
...
const homeworkTasks = [
  ...
  task(9, "17,1 * 3,8 / 4,5 * 0,5", "7,22", "decimal_multiply_divide", "drill", "standard"),
  task(10, "81,9 / 4,5 / 0,28 * 1,2", "78", "decimal_multiply_divide", "drill", "standard"),
  task(11, "6 - 2 * 4", "-2", "operation_order"),
  task(12, "(6 - 2) * 4", "16", "operation_order"),
  task(13, "18 / 3 * 2", "12", "operation_order"),
  task(14, "18 / (3 * 2)", "3", "operation_order"),
  ...
  task(20, "Ученик написал: 18 / 3 * 2 = 3. Найди ошибку.", "18 / 3 * 2 = 12. Умножение и деление выполняются слева направо.", "operation_order", "error_analysis"),
