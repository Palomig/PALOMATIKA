...
_svg1 = (
    '<line x1="40" y1="40" x2="150" y2="40" ' + L + '/>'      # P..B..C верх
    '<line x1="40" y1="40" x2="90" y2="180" ' + L + '/>'      # P..A
    '<line x1="90" y1="180" x2="230" y2="180" ' + L + '/>'    # A..E..D низ
    '<line x1="120" y1="40" x2="120" y2="180" ' + L + '/>'    # B..A? (BA лев бок)
    '<line x1="150" y1="40" x2="170" y2="180" ' + L + '/>'    # C..E выс
    '<line x1="40" y1="40" x2="230" y2="180" ' + L + '/>'     # P..D (через M)
    '<rect x="158" y="168" width="12" height="12" ' + AUX + '/>'  # прямой угол при E
    + vtx(40, 40, 'P', -16, 0) + vtx(120, 40, 'B', -4, -8) + vtx(150, 40, 'C', 4, -8)
    + vtx(90, 180, 'A', -14, 6) + vtx(170, 180, 'E', -4, 18) + vtx(230, 180, 'D', 6, 6)
    + '<circle cx="108" cy="110" r="2.5" fill="#111"/><text x="92" y="112" font-size="13" font-style="italic" fill="#111">M</text>'
    + val(78, 34, '9') + val(132, 34, '4') + val(128, 120, '12') + val(165, 120, '13')
    + val(126, 196, '4') + val(196, 196, '5')
)
SOL[1] = (
