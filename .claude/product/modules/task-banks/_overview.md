...
**1450**: тема 14 «Вычисления» 854/873, 16 «Степени» 255/274, 17
«Уравнение» 341/353. Остальные 5366 задач лежат в `draft`: ученику не
показываются, в вариант не попадают. У учителя в picker'е видны только
темы с ответами — `supportedTasks` требует ответ, и пустая вкладка ему ни
к чему.

Крупнейшее незакрытое — 12 «Планиметрия» (1212 задач, условие рисунком),
15 «Проценты» (491), 04 «Расчёт по формуле» (448), 05 «Вероятность» (370).
