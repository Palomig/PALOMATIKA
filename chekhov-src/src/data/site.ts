...
export const site = {
  ...
  email: 'tutor@palomatika.ru',

  // Каноничный домен (используется в OG/canonical)
  domain: 'https://palomatika.ru',
  basePath: '/chekhov',
...
export const nav = [
  { href: '/chekhov/',             label: 'Главная' },
  { href: '/chekhov/matematika/',  label: 'Математика' },
  { href: '/chekhov/informatika/', label: 'Информатика' },
  { href: '/chekhov/fizika/',      label: 'Физика' },
  { href: '/chekhov/oge/',         label: 'ОГЭ' },
  { href: '/chekhov/ege/',         label: 'ЕГЭ' },
  { href: '/chekhov/ceny/',        label: 'Цены' },
  { href: '/chekhov/kabinet/',     label: 'Кабинет' },
  { href: '/chekhov/otzyvy/',      label: 'Отзывы' },
  { href: '/chekhov/kontakty/',    label: 'Контакты' },
  { href: '/chekhov/blog/',        label: 'Блог' },
];
